...
CREATE TABLE `productsubcategory` (
  ...
  CONSTRAINT `ProductCategory` FOREIGN KEY (`ProductCategory`) REFERENCES `productcategory` (`ProductCategoryId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2011-10-26  6:57:28
