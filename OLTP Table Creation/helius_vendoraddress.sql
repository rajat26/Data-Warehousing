...
CREATE TABLE `vendoraddress` (
  ...
  CONSTRAINT `AddressTypeId` FOREIGN KEY (`AddressTypeId`) REFERENCES `addresstype` (`AddressTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Vendor` FOREIGN KEY (`VendorId`) REFERENCES `vendor` (`VendorId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `vendoraddress` WRITE;
/*!40000 ALTER TABLE `vendoraddress` DISABLE KEYS */;
/*!40000 ALTER TABLE `vendoraddress` ENABLE KEYS */;
UNLOCK TABLES;
