...
CREATE TABLE `vendorcontact` (
  ...
  KEY `Vend` (`VendorId`),
  KEY `Cont` (`ContactId`),
  KEY `ContactTyp` (`ContactTypeId`),
  CONSTRAINT `Cont` FOREIGN KEY (`ContactId`) REFERENCES `contact` (`ContactId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `ContactTyp` FOREIGN KEY (`ContactTypeId`) REFERENCES `contacttype` (`ContactTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Vend` FOREIGN KEY (`VendorId`) REFERENCES `vendor` (`VendorId`) ON DELETE NO ACTION ON UPDATE NO ACTION
