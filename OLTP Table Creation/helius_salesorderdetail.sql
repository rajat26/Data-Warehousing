...
CREATE TABLE `salesorderdetail` (
  ...
  `UnitPriceDiscount` decimal(19,4) DEFAULT NULL,
  `LineTotal` decimal(38,6) DEFAULT NULL,
  PRIMARY KEY (`SalesOrderDetailId`,`SalesOrderId`),
  KEY `SalesOrdr` (`SalesOrderId`),
  CONSTRAINT `SalesOrdr` FOREIGN KEY (`SalesOrderId`) REFERENCES `salesorderheader` (`SalesOrderId`) ON DELETE NO ACTION ON UPDATE NO ACTION
