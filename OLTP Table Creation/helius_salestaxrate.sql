...
CREATE TABLE `salestaxrate` (
  ...
  UNIQUE KEY `ST` (`TaxType`,`StateProvinceId`),
  KEY `StateProvince` (`SalesTaxRateId`),
  CONSTRAINT `StateProvince` FOREIGN KEY (`SalesTaxRateId`) REFERENCES `stateprovince` (`StateProvinceId`) ON DELETE NO ACTION ON UPDATE NO ACTION
